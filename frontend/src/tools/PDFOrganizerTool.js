...
const OrganizePDF = ({ file, onClose }) => {
...
const PDFOrganizerTool = () => {
    return (
        <PDFToolWrapper title="Organize PDF" description="Reorder and delete pages">
            <OrganizePDF />
        </PDFToolWrapper>
    );
};

PDFOrganizerTool.metadata = {
  id: 'pdf-organizer',
  name: 'PDF Organizer',
  description: 'Reorder and delete pages from PDF',
  category: 'file',
