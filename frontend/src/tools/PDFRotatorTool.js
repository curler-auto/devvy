...
const PDFRotatorTool = () => {
    return (
        <PDFToolWrapper title="Rotate PDF" description="Rotate pages in your PDF">
            <RotatePDF />
        </PDFToolWrapper>
    );
};

PDFRotatorTool.metadata = {
  id: 'pdf-rotator',
  name: 'PDF Rotator',
