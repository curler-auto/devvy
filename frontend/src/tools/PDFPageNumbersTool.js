...
const PageNumbersPDF = ({ file, onClose }) => {
...
const PDFPageNumbersTool = () => {
    return (
        <PDFToolWrapper title="Page Numbers" description="Add page numbers to your PDF">
            <PageNumbersPDF />
        </PDFToolWrapper>
    );
};

PDFPageNumbersTool.metadata = {
  id: 'pdf-page-numbers',
