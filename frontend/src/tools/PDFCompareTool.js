...
const PDFCompareTool = () => {
    return (
        <PDFToolWrapper title="Compare PDF" description="Compare two PDF files">
            <ComparePDF />
        </PDFToolWrapper>
    );
};

PDFCompareTool.metadata = {
  id: 'pdf-compare',
  name: 'Compare PDF',
  description: 'Overlay and compare two PDF files',
  category: 'file',
